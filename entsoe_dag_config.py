ENTSOE_VARIABLES = {
    ...
    "Day-ahead Total Load Forecast": {
        "table": "total_load_forecast_day_ahead",
        "AreaType": "country_domain",
        'xml_parsing_info': {"column_name": 'ns:mRID', "resolution": 'PT15M'},
    ...
    "Actual Generation per Generation Unit": {
        "table": "actual_generation_per_production_unit",
...
COUNTRY_MAPPING = {
    #LAST_USED: "PL": {"name": "Poland", "country_domain": ["10YPL-AREA-----S"], "bidding_zones" : ["10YPL-AREA-----S"]},
    #"DE": {"name": "Germany", "country_domain": ["10Y1001A1001A82H"], "bidding_zones": ["10YDE-VE-------2", "10YDE-EON------1", "10YDE-ENBW-----N"]},
    #LAST_USED: "DE": {"name": "Germany", "country_domain": ["10Y1001A1001A82H"], "bidding_zones": ["10YDE-VE-------2", "10YDE-EON------1", "10YDE-ENBW-----N", "10YDE-RWENET---I"]},
