ENTSOE_VARIABLES = {
    "Energy Prices fixing I": {
        ...
        "xml_parsing_info": {
            "column_name": "ns:mRID",
            "resolution": "PT60M",
        },  # ns will be inferred when parsing xml
    ...
    "Generation Forecasts for Wind and Solar": {
        ...
        "AreaType": "country_domain",
        "xml_parsing_info": {
            "column_name": "ns:MktPSRType/ns:psrType",
            "resolution": "PT15M",
        },
    ...
    "Actual Generation per Generation Unit": {
        ...
        "xml_parsing_info": {
            "column_name": "ns:MktPSRType/ns:PowerSystemResources/ns:name",
            "resolution": "PT60M",
        },
...
COUNTRY_MAPPING = {
    "PL": {
        "name": "Poland",
        "country_domain": ["10YPL-AREA-----S"],
        "bidding_zones": ["10YPL-AREA-----S"],
    },
